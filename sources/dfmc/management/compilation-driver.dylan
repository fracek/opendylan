...
define program-warning <variable-defined-but-not-used>
  slot condition-variable-name,
    required-init-keyword: variable-name:;
  format-string    "The variable %s is defined but not used.";
  format-arguments variable-name;
end program-warning;

define program-warning <method-argument-not-used>
  slot condition-variable-name,
    required-init-keyword: argument-name:;
  format-string    "The method argument %s is not used.";
...
define method check-method-local-bindings
    (meth :: <&initializer-method>)
 => ()
  ignore(meth);
end;

define method check-method-local-bindings
    (meth :: <&slot-initializer-method>)
 => ()
  ignore(meth);
end;
